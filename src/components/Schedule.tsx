...
const ScheduleTimes = ({ isBannerWidth }: ScheduleTimesProps) => (
  ...
  >
    ...
    >
      ...
      <li className='text-xs sm:text-sm md:text-md w-full justify-between flex flex-nowrap'>
        HAP KI DO <div className='ml-8 flex grow justify-end text-end'>(ages 13+) Tues/Thu:  6-7:30pm</div>
      </li>
      <li className='text-xs sm:text-sm md:text-md w-full justify-between flex flex-nowrap'>
        KICK BOXING <div className='ml-8 flex grow justify-end text-end'>Mon/Wed/Fri: 8:30-9:30pm*</div>
      </li>
      <li className='text-xs sm:text-sm md:text-md w-full justify-between flex flex-nowrap'>
