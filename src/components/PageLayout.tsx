...
export const PageLayout = ({ children, currentPathname }: PageLayoutProps) => {
  ...
  return (
    <ErrorBoundary>
      <div className='relative flex flex-col h-fit min-h-screen bg-gray-100 dark:bg-slate/90 text-black dark:text-white'>
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(https://res.cloudinary.com/dtweazqf2/image/upload/q_auto,f_auto,o_10/v1694115864/AMAA/AMAA_mpjsg0.gif)',
