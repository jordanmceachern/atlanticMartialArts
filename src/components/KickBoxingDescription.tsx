...
export const KickBoxingDescription = () => (
  ...
  >
    ...
    >
      <h2 className='text-sm sm:text-md md:text-base w-full flex justify-center underline mb-3'>Kick Boxing</h2>
      <p className='text-xs sm:text-sm md:text-md w-full justify-start flex flex-nowrap mb-3'>
