  ...
  <div className='z-20 bg-slate shadow shadow-black w-full py-2 flex justify-self-end justify-center'>
    <div className='w-full flex justify-center items-center max-w-3xl'>
      <div
        ...
        className='flex h-16 w-16 sm:h-20 sm:w-20 mx-2'
        style={{
          background:
      ...
      <div className='flex mb-1 flex-col items-center text-center text-white text-sm sm:text-base max-w-3xl whitespace-nowrap'>
        ...
        <div className='flex flex-col justify-center'>
          <a className='px-2 my-1 flex justify-center text-white text-xs sm:text-sm hover:bg-white/20' href='mailto:maritimemartialarts@hotmail.com' target='_top'>
            Email Us
          </a>
          <a className='px-2 flex justify-center text-white text-xs sm:text-sm hover:bg-white/20' href="tel:506-440-3883">
            Phone
          </a>
        </div>
      </div>
