      ...
      <div className='flex flex-col grow items-center justify-start'>
        <div className='grid grid-cols-1 gap-4 md:grid-cols-2 m-4 sm:mx-16 md:min-w-[500px] max-w-[940px]'>
          <CarouselWrapper wrapperClassName='col-start-1 col-end-2 md:col-end-3 overflow-y-hidden'>
            {/* Item 1 */}
            <Banner backgroundImage='https://res.cloudinary.com/dtweazqf2/image/upload/q_auto,f_auto/v1709316030/AMAA/cktaehighkick_shdqwh.jpg' className='h-full'>
            ...
            {/* Item 2 */}
            <Banner backgroundImage='https://res.cloudinary.com/dtweazqf2/image/upload/f_auto,q_auto/v1709314082/AMAA/coreconditioning_mdzsaq.jpg' className='h-full' />
            {/* Item 3 */}
            <Banner backgroundImage='https://res.cloudinary.com/dtweazqf2/image/upload/q_auto,f_auto/v1701109343/AMAA/IMG_5001_1_h8n916.jpg' className='h-full' />
            {/* Item 4 */}
            <Banner backgroundImage='https://res.cloudinary.com/dtweazqf2/image/upload/q_auto,f_auto/v1701109345/AMAA/IMG_4997_ats0ld.jpg' className='h-full' />
            {/* Item 5 */}
            <Banner backgroundImage='https://res.cloudinary.com/dtweazqf2/image/upload/q_auto,f_auto/v1695570360/AMAA/masters_mu5jtp.jpg' className='h-full' />
          </CarouselWrapper>
